...
\section{Strength-Based Design Framework}

This section translates the six cognitive strength--executive challenge pairings
identified in Section~2.1 into abstract design principles for PP. Each principle
serves as a conceptual bridge between the observed ADHD characteristic and the
interaction approach adopted in the application. Neurological evidence is not
repeated here; this section focuses on the design rationale. Table~\ref{tab:framework}
summarises all six pairings and their derived principles.

\textbf{Cognitive Vitality / Concentration.}
Cognitive vitality characterises the spontaneous, internally driven ideation of
people with ADHD, which conflicts with demands for sustained external attention.
This suggests that divergent thinking may be engaged as a resource rather than
suppressed as a distraction. \textit{Derived design principle:} Use divergent
thinking as an entry point for redirecting attention toward externally required
tasks.

\textbf{Courage / Emotion.}
Courage captures the tendency of people with ADHD to embrace uncertainty and
make rapid decisions under positive short-term conditions. The same emotional
profile, however, produces aversive responses to anticipated long-term outcomes
and procrastination under delayed reward. \textit{Derived design principle:}
Support task engagement through positively framed, short-horizon actions that
replace aversive or distant outcomes.

\textbf{Energy / Activation.}
Energy describes the willpower that people with ADHD experience when pursuing
personally meaningful goals, potentially producing hyper-focus in the presence
of a motivating purpose. The corresponding challenge is difficulty initiating
and prioritising tasks that lack personal significance. \textit{Derived design
principle:} Connect tasks to personally meaningful goals and higher-order
purposes to support willpower and task initiation.

\textbf{Humanity / Execution.}
Humanity encompasses social intelligence, empathy, and positive emotional
contagion. The corresponding challenge is difficulty adapting behaviour to
changing situational demands. \textit{Derived design principle:} Use social
connectedness and positive emotional expression to support sustained engagement
and positive affect during task execution.

\textbf{Resilience / Effort.}
Resilience describes the capacity of people with ADHD for self-regulation and
adaptive coping under adverse conditions, though mental fatigue under prolonged
cognitive load limits the effectiveness of sustained self-regulation.
\textit{Derived design principle:} Offer adaptive coping strategies as flexible
and optional resources during periods of cognitive fatigue, rather than as fixed
requirements.

\textbf{Transcendence / Memory.}
Transcendence captures the deep aesthetic absorption characteristic of people
with ADHD. The corresponding challenge is difficulty retaining information in
working memory during routine or low-stimulation tasks. \textit{Derived design
principle:} Use visually or aesthetically meaningful representations of
...
PP implements one interaction module per cognitive strength--executive challenge
pairing. Each module description below follows the structure: \textit{executive
challenge / cognitive strength / derived design principle / PP implementation /
intended interaction outcome}.
